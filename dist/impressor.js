...
(function(exports) {
  ...
  var createImages = function (_732) {
      return function (srcSize) {
          return function (targetSizes) {
              var createImage = function (_733) {
                  var targetHeight = Data_Maybe.maybe(_733.w / Impressor_Utils.aspectRatio(srcSize))(Prelude.id(Prelude.categoryFn))(_733.h);
                  var croppingProps$prime = croppingProps(srcSize)(_733);
                  var maxHeight = $$Math.max(targetHeight)(croppingProps$prime.h);
                  var maxWidth = $$Math.max(_733.w)(croppingProps$prime.w);
                  var srcScale = croppingProps$prime.w / _733.w;
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(maxWidth)(_732.canvas))(Graphics_Canvas.setCanvasHeight(maxHeight))))(function () {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.drawImageFull(_732.ctx)(_732.img)(croppingProps$prime.left)(croppingProps$prime.top)(croppingProps$prime.w)(croppingProps$prime.h)(0.0)(0.0)(maxWidth)(maxHeight)))(function () {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.getImageData(_732.ctx)(0.0)(0.0)(maxWidth)(maxHeight)))(function (_87) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  var _2730 = srcScale > 1.0;
                                  if (_2730) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(_733.w)(_732.canvas))(Graphics_Canvas.setCanvasHeight(targetHeight))))(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.createBlankImageData({
                                              ...
                                              return Impressor_Workers.downScaleImageWorker(1.0 / srcScale)(_87)(_84);
                                          });
                                      });
                                  };
                                  if (!_2730) {
                                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(_87);
                                  };
                                  throw new Error("Failed pattern match at Impressor line 59, column 3 - line 60, column 3: " + [ _2730.constructor.name ]);
                              })())(function (_86) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.putImageData(_732.ctx)(_86)(0.0)(0.0)))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.canvasToDataURL_("image/jpeg")(imageQuality)(_732.canvas)))(function (_85) {
                                          return Prelude["return"](Control_Monad_Aff.applicativeAff)({
                                              name: _733.name, 
                                              blob: Impressor_Utils.unsafeDataUrlToBlob(_85)
                                          });
                                      });
                                  });
                              });
  ...
  var impress = function (img) {
      return function (sizes) {
          return function (cb) {
              ...
              var parsedArgs = Prelude["<$>"](Data_Either.functorEither)(Impressor_Types.ParsedArgs)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (_5) {
                  return function (_6) {
                      return {
                          img: _5, 
                          sizes: _6
              ...
              var createImages$prime = function (_734) {
                  return function __do() {
                      var _90 = Impressor_Utils.createCanvasElement();
                      var _89 = Graphics_Canvas.getContext2D(_90)();
                      var _88 = Impressor_Utils.getImageSize(_734.img)();
...
module.exports = PS;
},{"../workers/downScaleImageWorker":4,"webworkify":3}],2:[function(require,module,exports){
"use strict";
...
},{"./dist/impressor":1}],3:[function(require,module,exports){
