...
})(PS["Impressor.DownScaleImage"] = PS["Impressor.DownScaleImage"] || {});
(function(exports) {
  // Generated by psc version 0.7.4.1
  "use strict";
  var $foreign = PS["Impressor.DownScaleImage"];
  var Prelude = PS["Prelude"];
  var Data_Function = PS["Data.Function"];
  var Graphics_Canvas = PS["Graphics.Canvas"];     
  var downScaleImage = function (scale) {
      return function (srcImageData) {
          return function (blankTargetImageData) {
              return $foreign.downScaleImageImpl(scale, srcImageData, blankTargetImageData);
          };
      };
  };
...
(function(exports) {
  ...
  var Graphics_Canvas = PS["Graphics.Canvas"];
  var Impressor_DownScaleImage = PS["Impressor.DownScaleImage"];
                  ...
                  return function __do() {
                      ...
                      return (function () {
                          var resImageData = (function () {
                              ...
                              if (_24) {
                                  return Impressor_DownScaleImage.downScaleImage(1.0 / srcScale)(_2)(_1);
                              };
                              if (!_24) {
                                  return _2;
                              };
                              throw new Error("Failed pattern match at Impressor line 91, column 9 - line 94, column 5: " + [ _24.constructor.name ]);
                          })();
                          return function __do() {
