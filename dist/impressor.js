...
(function(exports) {
  ...
  var readCanvasImageSource = function (img) {
      return $foreign.readCanvasImageSourceImpl(img, function (_21) {
          return Data_Either.Left.create(Data_Foreign.TypeMismatch.create("canvas image source element")(_21));
...
(function(exports) {
  ...
  var createCanvasElement = function __do() {
      ...
      return Prelude["<$>"](Control_Monad_Eff.functorEff)(Impressor_Types.elementToCanvasElement)(DOM_Node_Document.createElement("canvas")(_5))();
  };
  var createBlankImageData = function (_15) {
      return function __do() {
          var _7 = createCanvasElement();
          var _6 = Graphics_Canvas.getContext2D(_7)();
          Graphics_Canvas.setCanvasWidth(_15.w)(_7)();
          Graphics_Canvas.setCanvasHeight(_15.h)(_7)();
          return Graphics_Canvas.getImageData(_6)(0.0)(0.0)(_15.w)(_15.h)();
      };
  };
  var aspectRatio$prime = function (sourceRatio) {
      return function (_17) {
          return _17.w / Data_Maybe.maybe(_17.w / sourceRatio)(Prelude.id(Prelude.categoryFn))(_17.h);
      };
  };
  var aspectRatio = function (_16) {
      return _16.w / _16.h;
  };
...
(function(exports) {
  ...
  var createImages = function (_18) {
      return function (srcSize) {
          return function (targetSizes) {
              var createImage = function (_19) {
                  var targetHeight = Data_Maybe.maybe(_19.w / Impressor_Utils.aspectRatio(srcSize))(Prelude.id(Prelude.categoryFn))(_19.h);
                  var croppingProps$prime = croppingProps(srcSize)(_19);
                  var maxHeight = $$Math.max(targetHeight)(croppingProps$prime.h);
                  var maxWidth = $$Math.max(_19.w)(croppingProps$prime.w);
                  var srcScale = croppingProps$prime.w / _19.w;
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(maxWidth)(_18.canvas))(Graphics_Canvas.setCanvasHeight(maxHeight))))(function () {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.drawImageFull(_18.ctx)(_18.img)(croppingProps$prime.left)(croppingProps$prime.top)(croppingProps$prime.w)(croppingProps$prime.h)(0.0)(0.0)(maxWidth)(maxHeight)))(function () {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.getImageData(_18.ctx)(0.0)(0.0)(maxWidth)(maxHeight)))(function (_11) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  var _44 = srcScale > 1.0;
                                  if (_44) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(_19.w)(_18.canvas))(Graphics_Canvas.setCanvasHeight(targetHeight))))(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.createBlankImageData({
                                              ...
                                              return Impressor_Workers.downScaleImageWorker(1.0 / srcScale)(_11)(_8);
                                          });
                                      });
                                  };
                                  if (!_44) {
                                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(_11);
                                  };
                                  throw new Error("Failed pattern match at Impressor line 59, column 3 - line 60, column 3: " + [ _44.constructor.name ]);
                              })())(function (_10) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.putImageData(_18.ctx)(_10)(0.0)(0.0)))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.canvasToDataURL_("image/jpeg")(imageQuality)(_18.canvas)))(function (_9) {
                                          return Prelude["return"](Control_Monad_Aff.applicativeAff)({
                                              name: _19.name, 
                                              blob: Impressor_Utils.unsafeDataUrlToBlob(_9)
                                          });
                                      });
                                  });
                              });
  ...
  var impress = function (img) {
      return function (sizes) {
          return function (cb) {
              ...
              var parsedArgs = Prelude["<$>"](Data_Either.functorEither)(Impressor_Types.ParsedArgs)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (_3) {
                  return function (_4) {
                      return {
                          img: _3, 
                          sizes: _4
              ...
              var createImages$prime = function (_20) {
                  return function __do() {
                      var _14 = Impressor_Utils.createCanvasElement();
                      var _13 = Graphics_Canvas.getContext2D(_14)();
                      var _12 = Impressor_Utils.getImageSize(_20.img)();
                      return Control_Monad_Aff.runAff(Prelude["const"](Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit)))(Data_Function.runFn1(cb))(createImages({
                          canvas: _14, 
                          ctx: _13, 
                          img: _20.img
                      })(_12)(_20.sizes))();
