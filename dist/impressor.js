...
/***/ function(module, exports) {
	...
	(function(exports) {
	  ...
	  var createCanvasElement = function __do() {
	      var _75 = Prelude["<$>"](Control_Monad_Eff.functorEff)(DOM_HTML_Types.htmlDocumentToDocument)(Control_Bind["=<<"](Control_Monad_Eff.bindEff)(DOM_HTML_Window.document)(DOM_HTML.window))();
	      return Prelude["<$>"](Control_Monad_Eff.functorEff)($foreign.elementToCanvasElement)(DOM_Node_Document.createElement("canvas")(_75))();
	  };
	  ...
	  var onWindowLoad = function (eff) {
	      return Control_Bind["=<<"](Control_Monad_Eff.bindEff)(function (_2686) {
	          return DOM_Event_EventTarget.addEventListener(DOM_Event_EventTypes.load)(DOM_Event_EventTarget.eventListener(always(eff)))(false)(DOM_HTML_Types.windowToEventTarget(_2686));
	      })(DOM_HTML.window);
	  };
	...
	(function(exports) {
	  ...
	  var croppingProps = function (src) {
	      return function (target) {
	          ...
	          var left = (function () {
	              ...
	              throw new Error("Failed pattern match at Impressor line 45, column 1 - line 46, column 1: " + [ isWiderThanTarget.constructor.name ]);
	          })();
	          var top = (function () {
	              if (isWiderThanTarget) {
	                  return 0.0;
	  ...
	  var createImages = function (canvas) {
	          ...
	          return function (targetSizes_1) {
	              ...
	              var createImage = function (targetSize) {
	                  return function __do() {
	                      ...
	                      var _0 = Graphics_Canvas.canvasToDataURL(canvas.el)();
	                      Graphics_Canvas.clearRect(canvas.ctx)({
	                          x: 0.0, 
	                          y: 0.0, 
	                          w: targetSize.w, 
	                          h: targetSize.h
	  ...
	  var main = Utils.onWindowLoad(function __do() {
	      ...
	      var _3 = Utils.getImageById("image")();
	      var _2 = Utils.getImageDimensions(_3)();
	      var _1 = createImages({
	          el: _5, 
	          ctx: _4, 
	          img: _3
