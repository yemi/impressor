...
(function(exports) {
  ...
  var traverse_ = function (__dict_Applicative_0) {
      return function (__dict_Foldable_1) {
          return function (f) {
              return foldr(__dict_Foldable_1)(function (_1089) {
                  return Control_Apply["*>"](__dict_Applicative_0["__superclass_Prelude.Apply_0"]())(f(_1089));
...
(function(exports) {
  ...
  var functorList = new Prelude.Functor(function (f) {
      return function (_629) {
          ...
          if (_629 instanceof Cons) {
              return new Cons(f(_629.value0), Prelude["<$>"](functorList)(f)(_629.value1));
          };
          throw new Error("Failed pattern match: " + [ f.constructor.name, _629.constructor.name ]);
      };
  });
      ...
      return function (f) {
          return Data_Foldable.foldl(foldableList)(function (acc) {
              return function (_2396) {
                  return Prelude.append(__dict_Monoid_16["__superclass_Prelude.Semigroup_0"]())(acc)(f(_2396));
              };
      ...
      var go = function (__copy_o) {
          return function (__copy_b) {
              return function (__copy__631) {
                  ...
                  tco: while (true) {
                      var b_1 = b;
                      if (_631 instanceof Nil) {
                          return b_1;
                      };
                      if (_631 instanceof Cons) {
                          var __tco_o = o;
                          var __tco_b = o(b)(_631.value0);
                      ...
                      throw new Error("Failed pattern match: " + [ o.constructor.name, b.constructor.name, _631.constructor.name ]);
                  };
              };
          };
      };
      ...
      return function (b) {
          return function (_630) {
              ...
              if (_630 instanceof Cons) {
                  return o(_630.value0)(Data_Foldable.foldr(foldableList)(o)(b)(_630.value1));
              };
  ...
  var traversableList = new Data_Traversable.Traversable(function () {
      ...
      return function (_634) {
          ...
          if (_634 instanceof Cons) {
              return Prelude["<*>"](__dict_Applicative_2["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_2["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Cons.create)(_634.value0))(Data_Traversable.sequence(traversableList)(__dict_Applicative_2)(_634.value1));
          };
      ...
      return function (f) {
          return function (_633) {
              ...
              if (_633 instanceof Cons) {
                  return Prelude["<*>"](__dict_Applicative_1["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_1["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Cons.create)(f(_633.value0)))(Data_Traversable.traverse(traversableList)(__dict_Applicative_1)(f)(_633.value1));
              };
              throw new Error("Failed pattern match: " + [ f.constructor.name, _633.constructor.name ]);
          };
      };
  });
  exports["Nil"] = Nil;
...
(function(exports) {
  ...
  var getCanvasImageSource = function (selector) {
      return Control_Bind["=<<"](Control_Monad_Eff.bindEff)(function (_13) {
          return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.flip(Prelude.bind(Data_Maybe.bindMaybe))(htmlElementToCanvasImageSource)(_13));
  ...
  var onWindowLoad = function (eff) {
      return Control_Bind["=<<"](Control_Monad_Eff.bindEff)(function (_14) {
          return DOM_Event_EventTarget.addEventListener(DOM_Event_EventTypes.load)(DOM_Event_EventTarget.eventListener(always(eff)))(false)(DOM_HTML_Types.windowToEventTarget(_14));
      })(DOM_HTML.window);
  };
