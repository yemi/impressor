(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["impressor"] = factory();
	else
		root["impressor"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var impress = __webpack_require__(1).Impressor.impress
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(exports) {
	  ...
	  var downScaleImageWorker = __webpack_require__(3);
	...
	(function(exports) {
	  ...
	  var readCanvasImageSource = function (img) {
	      return $foreign.readCanvasImageSourceImpl(img, function ($3) {
	          return Data_Either.Left.create(Data_Foreign.TypeMismatch.create("canvas image source element")($3));
	      }, Data_Either.Right.create);
	  };
	  var isForeignTargetSize = new Data_Foreign_Class.IsForeign(function (obj) {
	      return Prelude["<$>"](Data_Either.functorEither)(TargetSize)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (v) {
	          return function (v1) {
	              return function (v2) {
	                  return {
	                      w: v, 
	...
	(function(exports) {
	  ...
	  var createCanvasElement = function __do() {
	      var v = Prelude["<$>"](Control_Monad_Eff.functorEff)(DOM_HTML_Types.htmlDocumentToDocument)(Control_Bind["=<<"](Control_Monad_Eff.bindEff)(DOM_HTML_Window.document)(DOM_HTML.window))();
	      return Prelude["<$>"](Control_Monad_Eff.functorEff)(Impressor_Types.elementToCanvasElement)(DOM_Node_Document.createElement("canvas")(v))();
	  };
	  var createBlankImageData = function (v) {
	      return function __do() {
	          var v1 = createCanvasElement();
	          var v2 = Graphics_Canvas.getContext2D(v1)();
	          Graphics_Canvas.setCanvasWidth(v.w)(v1)();
	          Graphics_Canvas.setCanvasHeight(v.h)(v1)();
	          return Graphics_Canvas.getImageData(v2)(0.0)(0.0)(v.w)(v.h)();
	      };
	  };
	  var aspectRatio$prime = function (sourceRatio) {
	      return function (v) {
	          return v.w / Data_Maybe.maybe(v.w / sourceRatio)(Prelude.id(Prelude.categoryFn))(v.h);
	      };
	  };
	...
	(function(exports) {
	  ...
	  var croppingProps = function (src) {
	      return function (target) {
	          ...
	          var top = (function () {
	              ...
	              throw new Error("Failed pattern match at Impressor line 45, column 9 - line 46, column 3: " + [ srcHasHigherAspectRatioThanTarget.constructor.name ]);
	          })();
	          var width = (function () {
	              if (srcHasHigherAspectRatioThanTarget) {
	              ...
	              throw new Error("Failed pattern match at Impressor line 46, column 11 - line 47, column 3: " + [ srcHasHigherAspectRatioThanTarget.constructor.name ]);
	          })();
	          var left = (function () {
	              if (srcHasHigherAspectRatioThanTarget) {
	              ...
	              throw new Error("Failed pattern match at Impressor line 44, column 10 - line 45, column 3: " + [ srcHasHigherAspectRatioThanTarget.constructor.name ]);
	          })();
	          var height = (function () {
	              if (srcHasHigherAspectRatioThanTarget) {
	                  return src.h;
	              ...
	              throw new Error("Failed pattern match at Impressor line 47, column 12 - line 49, column 1: " + [ srcHasHigherAspectRatioThanTarget.constructor.name ]);
	          })();
	          return {
	              left: left, 
	              top: top, 
	  ...
	  var createImages = function (v) {
	      return function (srcSize) {
	          return function (targetSizes) {
	              var createImage = function (v1) {
	                  var targetHeight = Data_Maybe.maybe(v1.w / Impressor_Utils.aspectRatio(srcSize))(Prelude.id(Prelude.categoryFn))(v1.h);
	                  var croppingProps$prime = croppingProps(srcSize)(v1);
	                  var maxHeight = $$Math.max(targetHeight)(croppingProps$prime.h);
	                  var maxWidth = $$Math.max(v1.w)(croppingProps$prime.w);
	                  var srcScale = croppingProps$prime.w / v1.w;
	                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(maxWidth)(v.canvas))(Graphics_Canvas.setCanvasHeight(maxHeight))))(function () {
	                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.drawImageFull(v.ctx)(v.img)(croppingProps$prime.left)(croppingProps$prime.top)(croppingProps$prime.w)(croppingProps$prime.h)(0.0)(0.0)(maxWidth)(maxHeight)))(function () {
	                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.getImageData(v.ctx)(0.0)(0.0)(maxWidth)(maxHeight)))(function (v2) {
	                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
	                                  var $21 = srcScale > 1.0;
	                                  if ($21) {
	                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Graphics_Canvas.setCanvasWidth(v1.w)(v.canvas))(Graphics_Canvas.setCanvasHeight(targetHeight))))(function () {
	                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.createBlankImageData({
	                                              ...
	                                              return Impressor_Workers.downScaleImageWorker(1.0 / srcScale)(v2)(v3);
	                                          });
	                                      });
	                                  };
	                                  if (!$21) {
	                                  ...
	                                  throw new Error("Failed pattern match at Impressor line 76, column 21 - line 91, column 5: " + [ $21.constructor.name ]);
	                              })())(function (v3) {
	                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Canvas.putImageData(v.ctx)(v3)(0.0)(0.0)))(function () {
	                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Impressor_Utils.canvasToDataURL_("image/jpeg")(imageQuality)(v.canvas)))(function (v4) {
	                                          return Prelude["return"](Control_Monad_Aff.applicativeAff)({
	                                              name: v1.name, 
	                                              blob: Impressor_Utils.unsafeDataUrlToBlob(v4)
	                                          });
	                                      });
	                                  });
	                              });
	  ...
	  var impress = function (img) {
	      return function (sizes) {
	          return function (cb) {
	              ...
	              var parsedArgs = Prelude["<$>"](Data_Either.functorEither)(Impressor_Types.ParsedArgs)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (v) {
	                  return function (v1) {
	                      return {
	                          img: v, 
	                          sizes: v1
	              ...
	              var createImages$prime = function (v) {
	                  return function __do() {
	                      var v1 = Impressor_Utils.createCanvasElement();
	                      var v2 = Graphics_Canvas.getContext2D(v1)();
	                      var v3 = Impressor_Utils.getImageSize(v.img)();
...
;
//# sourceMappingURL=impressor.js.map