	...
	(function(exports) {
	  ...
	  var onWindowLoad = function (eff) {
	      return Control_Bind["=<<"](Control_Monad_Eff.bindEff)(function (_12) {
	          return DOM_Event_EventTarget.addEventListener(DOM_Event_EventTypes.load)(DOM_Event_EventTarget.eventListener(always(eff)))(false)(DOM_HTML_Types.windowToEventTarget(_12));
	      })(DOM_HTML.window);
	  };
	          ...
	          return function (targetSizes_1) {
	              ...
	              var createImage = function (targetSize) {
	                  return function __do() {
	                      ...
	                      var _0 = Graphics_Canvas.canvasToDataURL(_6.el)();
